...
public sealed class WeeklyRecurrenceHelperTests
{
    ...
    [Fact]
    public void Method_GetEndDateAndCount_returns_correct_data_for_twoWeeks()
    {
        // Arrange
        var startDate = new DateOnly(1, 1, 7); // Sunday
    ...
    [Fact]
    public void Method_GetEndDateAndCount_returns_correct_data_for_twoWeeks_2()
    {
        // Arrange
        var startDate = new DateOnly(1, 1, 1); // Monday
        var endDate = startDate.AddDays(8);
    ...
    [Fact]
    public void Method_GetEndDateAndCount_returns_correct_data_for_twoFullWeeks()
    {
        // Arrange
        var startDate = new DateOnly(1, 1, 7); // Sunday
    ...
    [Fact]
    public void Method_GetEndDateAndCount_returns_correct_data_for_twoFullWeeks_2()
    {
        // Arrange
        var startDate = new DateOnly(1, 1, 1); // Monday
        var endDate = startDate.AddDays(14);
    ...
    [Fact]
    public void Method_GetEndDateAndCount_returns_correct_data_for_oneWeek_max()
    {
        // Arrange
