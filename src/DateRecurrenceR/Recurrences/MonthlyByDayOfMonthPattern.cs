...
public readonly struct MonthlyByDayOfMonthPattern : ISpanParsable<MonthlyByDayOfMonthPattern>
{
    ...
    /// for example <c>20260101M1D15C10</c>.
    ...
    /// <summary>
    /// Parses a compact pattern string, for example <c>M1D15</c>,
    /// into a <see cref="MonthlyByDayOfMonthPattern"/>.
    /// </summary>
    ...
    /// <summary>
    /// Tries to parse a compact pattern string into a <see cref="MonthlyByDayOfMonthPattern"/>.
    /// </summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">Ignored; the format is culture-invariant.</param>
